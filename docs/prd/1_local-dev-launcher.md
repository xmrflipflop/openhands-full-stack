...
- **Dedicated ingress proxy vs. the frontend dev server's own proxying.** The frontend's built-in dev proxy is used; a separate ingress adds a moving part without covering any additional requirement.
